...
Route::post('/details', [DetailsLoadController::class, 'store'])->name('details.store');
Route::get('/details-loads/crear', [DetailsLoadController::class, 'crear'])->name('details-loads.crear');
Route::get('details-loads/{id}', [DetailsLoadController::class, 'show'])->name('details-loads.show');
