...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fonts/font-name.css') }}">
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/1.11.5/css/jquery.dataTables.min.css">
     ...
     <!-- Enlace al archivo CSS para definir el tipo de letra sans-serif -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item"> 
                                <a class="nav-link" href="{{ route('details_load.index') }}">{{ __('Detalle de Carga') }}</a>
                            </li>
