            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span id="card_title">{{ __('Carga') }}</span>
                            ...
                            <tbody>
                                @foreach ($loads as $load)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="{{ route('load.show', $load->id) }}" style="background-color: #004085; border-color: #003768;">
        ...
        <input type="hidden" name="status" value="{{ $load->enabled ? 0 : 1 }}">
                                        ...
                                        <td>
                                            <form action="{{ route('load.destroy', $load->id) }}" method="POST">
                                                @if($load->enabled)
                                                    <a class="btn btn-sm btn-success" href="{{ route('load.edit', $load->id) }}">
...
<script>
    ...
    function toggleSaleStatus(loadId, status) {
